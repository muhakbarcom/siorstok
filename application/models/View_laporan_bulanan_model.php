...
class View_laporan_bulanan_model extends CI_Model
{

    public $table = 'view_laporan_bulanan';
    public $id = '';
    public $order = 'DESC';
    ...
    function laporan_bulanan_total($q = NULL, $dari, $sampai)
    {
        //     $this->db->like('', $q);
        // $this->db->or_like('tanggal_transaksi', $q);
        // $this->db->or_like('qty_terjual', $q);
    ...
    // get data with limit and search
    function laporan_bulanan($limit, $start = 0, $q = NULL, $dari, $sampai)
    {
        $this->db->order_by($this->id, $this->order);
        //     $this->db->like('', $q);
        // $this->db->or_like('tanggal_transaksi', $q);
    ...
    function laporan_bulanan_x($q = NULL, $dari, $sampai)
    {
        $this->db->order_by($this->id, $this->order);
        //     $this->db->like('', $q);
        // $this->db->or_like('tanggal_transaksi', $q);
...
/* End of file View_laporan_bulanan_model.php */
/* Location: ./application/models/View_laporan_bulanan_model.php */
