...
<head>
  ...
  <script src="<?= base_url(); ?>assets/date_picker/bootstrap-datetimepicker.min.js"></script>
  ...
  <div class="wrapper">
    ...
    <footer class="main-footer">
      <div class="pull-right hidden-xs">
        <b>Developed by<a href="#"> Nazzilla Auliya</b></a>
      </div>
      <strong>Copyright &copy; <?= date('Y'); ?> <a href="#">NAZZILLA</a>.</strong> All rights
      reserved.
      <!-- copyright -->
