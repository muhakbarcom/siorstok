...
<div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">View_laporan_penjualan</h3>
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right"><form action="<?php echo site_url('laporan_penjualan/index'); ?>" class="form-inline" method="get" style="margin-top:10px">
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $laporan_penjualan->;?>" />&nbsp;</td>
