...
<div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">View_laporan_bulanan</h3>
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('view_laporan_bulanan/create'),'<i class="fa fa-plus"></i> Create', 'class="btn bg-purple"'); ?>
            </div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('view_laporan_bulanan'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
        ...
        <form method="post" action="<?= site_url('view_laporan_bulanan/deletebulk');?>" id="formbulk">
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $view_laporan_bulanan->;?>" />&nbsp;</td>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('view_laporan_bulanan/read/'.$view_laporan_bulanan->),'<i class="fa fa-search"></i>', 'class="btn btn-xs btn-primary"  data-toggle="tooltip" title="Detail"'); 
				echo ' '; 
				echo anchor(site_url('view_laporan_bulanan/update/'.$view_laporan_bulanan->),' <i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"'); 
				echo ' '; 
				echo anchor(site_url('view_laporan_bulanan/delete/'.$view_laporan_bulanan->),' <i class="fa fa-trash"></i>','class="btn btn-xs btn-danger" onclick="javasciprt: return confirmdelete(\'view_laporan_bulanan/delete/'.$view_laporan_bulanan->.'\')"  data-toggle="tooltip" title="Delete" '); 
				?>
			</td>
		</tr>
                <?php
    ...
    $("#formbulk").on("submit", function () {
        ...
        if (rowsel.join(",") == "") {
            ...
            var prompt = alertify.confirm('Apakah anda yakin akan menghapus data tersebut?',
                ...
                $.ajax({
                    url: "view_laporan_bulanan/deletebulk",
                    type: "post",
