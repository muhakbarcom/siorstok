    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Daftar Pesanan Masuk</h3>
                    ...
                    <table class="table table-bordered" style="margin-bottom: 10px" style="width:100%">
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($transaksi->status_pelayanan == 'Belum Dimasak') : ?>
                                        <a href="<?= base_url('transaksi/terima_koki/' . $transaksi->id_transaksi); ?>" class="btn btn-warning">Terima</a>
                                    <?php elseif ($transaksi->status_pelayanan == 'Proses Dimasak') : ?>
                                        <a href="<?= base_url('transaksi/konfirmasi_trx_koki_selesai/' . $transaksi->id_transaksi); ?>" class="btn btn-primary">Selesai</a>
                                    <?php else : ?>
                                        <a href="<?= base_url('transaksi/tampil_koki/' . $transaksi->id_transaksi); ?>" class="btn btn-info">View</a>
                                    <?php endif; ?>
