...
<div class="col-xs-12">
    <div class="box">
      <div class="box-header">
        <h3 class="box-title">View_laporan_harian</h3>
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('view_laporan_harian/create'),'<i class="fa fa-plus"></i> Create', 'class="btn bg-purple"'); ?>
            </div>
		...
		<?php echo anchor(site_url('view_laporan_harian/printdoc'), '<i class="fa fa-print"></i> Print Preview', 'class="btn bg-maroon"'); ?>
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $view_laporan_harian->;?>" />&nbsp;</td>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('view_laporan_harian/read/'.$view_laporan_harian->),'<i class="fa fa-search"></i>', 'class="btn btn-xs btn-primary"  data-toggle="tooltip" title="Detail"'); 
				echo ' '; 
				echo anchor(site_url('view_laporan_harian/update/'.$view_laporan_harian->),' <i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"'); 
				echo ' '; 
				echo anchor(site_url('view_laporan_harian/delete/'.$view_laporan_harian->),' <i class="fa fa-trash"></i>','class="btn btn-xs btn-danger" onclick="javasciprt: return confirmdelete(\'view_laporan_harian/delete/'.$view_laporan_harian->.'\')"  data-toggle="tooltip" title="Delete" '); 
				?>
			</td>
		</tr>
                <?php
